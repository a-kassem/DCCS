 ...
 void QueueLengthTracer1(uint32_t oldValue, uint32_t newValue)
{
 ...
 int main (int argc, char *argv[])
 {
   ...
   S1cwnd.open ("scratch/Fairness_Final/dccs_fairness/traces/S1cwnd", std::ios::out);
   S2cwnd.open ("scratch/Fairness_Final/dccs_fairness/traces/S2cwnd", std::ios::out);
   S3cwnd.open ("scratch/Fairness_Final/dccs_fairness/traces/S3cwnd", std::ios::out);
   S1rtt.open ("scratch/Fairness_Final/dccs_fairness/traces/S1rtt", std::ios::out);
   S2rtt.open ("scratch/Fairness_Final/dccs_fairness/traces/S2rtt", std::ios::out);
   S3rtt.open ("scratch/Fairness_Final/dccs_fairness/traces/S3rtt", std::ios::out);
   rxS1R1Throughput.open ("scratch/Fairness_Final/dccs_fairness/traces/s1-r1-throughput.dat", std::ios::out);
   rxS1R1Throughput << "#Time(s) flow thruput(Mb/s)" << std::endl;
   rxS2R2Throughput.open ("scratch/Fairness_Final/dccs_fairness/traces/s2-r2-throughput.dat", std::ios::out);
   rxS2R2Throughput << "#Time(s) flow thruput(Mb/s)" << std::endl;
   rxS3R1Throughput.open ("scratch/Fairness_Final/dccs_fairness/traces/s3-r1-throughput.dat", std::ios::out);
   rxS3R1Throughput << "#Time(s) flow thruput(Mb/s)" << std::endl;
   fairnessIndex.open ("scratch/Fairness_Final/output/dccs_fairness.dat", std::ios::out);
   t1QueueLength.open ("scratch/Fairness_Final/dccs_fairness/traces/t1-length.dat", std::ios::out);
   t1QueueLength << "#Time(s) qlen(pkts) qlen(us)" << std::endl;
   t2QueueLength.open ("scratch/Fairness_Final/dccs_fairness/traces/t2-length.dat", std::ios::out);
   t2QueueLength << "#Time(s) qlen(pkts) qlen(us)" << std::endl;
   r1QueueLength.open ("scratch/Fairness_Final/dccs_fairness/traces/r1-length.dat", std::ios::out);
