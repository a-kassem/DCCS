...
#ifndef TCP_DCCS_NO_FLOW_H
#define TCP_DCCS_NO_FLOW_H
...
namespace ns3
{
    ...
    class TcpDccsNoFlow : public TcpNewReno
    {
    public:
        ...
        TcpDccsNoFlow(const TcpDccsNoFlow& sock);

        ~TcpDccsNoFlow() override;
