...
int main (int argc, char *argv[])
{
    ...
    std::string tcpTypeId = "TcpDccsNoFlow";
    ...
    //Config::SetDefault("ns3::TcpDccs::NumFlows", UintegerValue(4));
    ...
    F1cwnd.open ("scratch/Convergence_Final/dccs_conv_without_flow_num/traces/F1cwnd", std::ios::out);
    F2cwnd.open ("scratch/Convergence_Final/dccs_conv_without_flow_num/traces/F2cwnd", std::ios::out);
    F1Throughput.open ("scratch/Convergence_Final/dccs_conv_without_flow_num/traces/F1Throughput", std::ios::out);
    F2Throughput.open ("scratch/Convergence_Final/dccs_conv_without_flow_num/traces/F2Throughput", std::ios::out);
    F1rtt.open ("scratch/Convergence_Final/dccs_conv_without_flow_num/traces/F1rtt", std::ios::out);
    F2rtt.open ("scratch/Convergence_Final/dccs_conv_without_flow_num/traces/F2rtt", std::ios::out);
