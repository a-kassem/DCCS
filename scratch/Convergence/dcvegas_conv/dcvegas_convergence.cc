...
int main (int argc, char *argv[])
{
    ...
    F1cwnd.open ("scratch/Convergence_Final/dcvegas_conv/traces/F1cwnd", std::ios::out);
    F2cwnd.open ("scratch/Convergence_Final/dcvegas_conv/traces/F2cwnd", std::ios::out);
    F1Throughput.open ("scratch/Convergence_Final/dcvegas_conv/traces/F1Throughput", std::ios::out);
    F2Throughput.open ("scratch/Convergence_Final/dcvegas_conv/traces/F2Throughput", std::ios::out);
    F1rtt.open ("scratch/Convergence_Final/dcvegas_conv/traces/F1rtt", std::ios::out);
    F2rtt.open ("scratch/Convergence_Final/dcvegas_conv/traces/F2rtt", std::ios::out);
